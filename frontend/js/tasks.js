...
function initTaskDetail(taskId) {
  ...
  Promise.all([
    ...
    var t = results[0];
    var html = '<div class="task-detail-page" style="width:80%;margin:0 auto;padding:20px">' +
...
function _renderTaskDetailBody(t) {
  ...
  html += '<div style="display:flex;gap:16px;align-items:flex-start">' +
    ...
    '<div style="flex:1;min-width:0;display:flex;flex-direction:column;gap:16px">' +
      ...
      // ── 产出物 ──
      (t.output_items && t.output_items.length
        ? '<div class="card info-glass-card" style="padding:20px">' +
...
function _wlOnDateChange(idx) {
  ...
  Promise.all([
    ...
    _wlRenderRowIncompleteHint(document.querySelector('#wl-rows .wl-row[data-idx="' + idx + '"]'), _wlDayIsIncomplete(weDay, d));
