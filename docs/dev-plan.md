...
当前版本：v2026.08.07-beta8 | 最后更新：2026-08-07
...
| 日期 | 版本 | 说明 |
|------|------|------|
| 2026-08-07 | v2026.08.07-beta8 | fix: 修复模板编辑时 base_path/file_pattern 未持久化导致路径信息丢失；pma-worktree skill 增加远端备份同步关闭步骤 |
| 2026-08-07 | v2026.08.07-beta7 | docs(skills): 新增 pma-daily-summary skill — 每日系统更新汇总报告自动生成 |
