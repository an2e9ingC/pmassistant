...
> 当前版本：v2026.07.07-beta3 | 最后更新：2026-07-06
...
| 日期 | 版本 | 说明 |
|------|------|------|
| 2026-07-07 | v2026.07.07-beta3 | fix: 产品详情跳转自动定位修复—所属分类→产品管理+文档模板→doc-templates双路径L3→L2 |
| 2026-07-06 | v2026.07.07-beta3 | feat: vsdx预览支持+产品框图直接内嵌渲染设计框图vsdx |
