...
当前版本：v2026.07.24-beta3 | 最后更新：2026-07-24
...
| 日期 | 版本 | 说明 |
|------|------|------|
| 2026-07-24 | v2026.07.24-beta3 | feat: GitLab Issue评论API+commit自动评论工作流 |
| 2026-07-24 | v2026.07.24-beta2 | fix: 产品模板可选+任务同步去重 (close #162,#163) |
| 2026-07-24 | v2026.07.24-beta1 | fix: 模板名重复检查+GitLab卡片对齐+仪表盘告警用PMA模型 (close #159,#160,#161) |
| 2026-07-23 | v2026.07.23-beta9 | fix: 阶段编辑权限控制 + 项目表单新增客户入口+中文搜索 (close #151,#153) |
