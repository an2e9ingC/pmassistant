...
当前版本：v2026.08.07-beta4 | 最后更新：2026-08-07
...
| 2026-08-07 | v2026.08.07-beta2 | feat: 优化项目状态使用场景 — 新增已废止状态、待启动延迟模板同步、已完成校验、状态机梳理 |
| 2026-08-07 | v2026.08.07-beta1 | fix: 远端备份配置保存按钮修复 + worktree skill sed 完善 |
| 2026-08-06 | v2026.08.06-beta3 | fix: 优先级颜色统一到 CSS .prio-tag 类 |
| 2026-08-06 | v2026.08.06-beta2 | feat: Bug状态机重构、抄送功能、任务/Bug操作列快捷按钮与内联编辑 |
| 2026-08-06 | v2026.08.06-beta1 | docs: worktree 环境自动关闭远端同步 |
