...
当前版本：v2026.08.14-beta1 | 最后更新：2026-08-14
...
| 日期 | 版本 | 说明 |
|------|------|------|
| 2026-08-14 | v2026.08.14-beta1 | feat: 项目详情信息卡片优化+Bug列表子页过滤（issue#265）— 关联项目移到关联商机同行+新增项目任务/项目Bug卡片(n/m)+Bug列表状态统计过滤卡片+严重程度/优先级/责任人过滤条+逐框清除 |
